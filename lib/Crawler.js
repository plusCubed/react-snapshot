  ...
  _createClass(Crawler, [{
    ...
    value: function snap() {
      ...
      return (0, _snapshot2.default)(this.protocol, this.host, urlPath, this.snapshotDelay).then(function (window) {
        ...
        if (_this.stripLink) {
          var _strip = new RegExp(_this.stripLink);
          Array.from(window.document.querySelectorAll('link')).forEach(function (link) {
            if (_strip.exec(_url2.default.parse(link.href).path)) link.remove();
          });
        }
